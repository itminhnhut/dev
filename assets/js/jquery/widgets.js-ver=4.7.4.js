! function() {
    Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function(t) {
        ...
        var r, i = n(1),
            ...
            v = n(266),
            g = "_e";
        u.set("http://platform.twitter.com/widgets.init", !0), a.set("init", !0), v(), r = new i, s.exposeReadyPromise(r.promise, a.base, g), a.set("widgets", h), a.set("http://platform.twitter.com/widgets.load", l.load), a.set("events", f), u.init("host", "http://platform.twitter.com/platform.twitter.com"), m(function() {
        ...
        function i(t) {
            var e;
            return t = t || [], e = t.length, t = t.filter(a), e ? e !== t.length ? u.reject("http://platform.twitter.com/non-Promise passed to .some") : new u(function(e, n) {
                function r() {
                    i += 1, i === t.length && n()
                }
                var i = 0;
            ...
            }) : u.reject("http://platform.twitter.com/no promises passed to .some")
        }
        ...
        function l(t) {
            var e = t || [];
            return e.unshift("http://platform.twitter.com/tweets.json"), p(_(), e)
        }
