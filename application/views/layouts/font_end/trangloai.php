        ...
        <div id="tl">
          ...
          <div class="shop-products row grid-view">
            ...
            if(!empty($data) ):
                ...
                <div class="product-wrapper">
                  <div class="list-col4 ">
                    <div class="product-image">
                      <a href="<?= base_url().'detail/'.$value['slug'].'/'.$value['id']?>"  title="Auctor gravida enim">
              ...
              <div class="list-col8 ">
                <div class="gridview">
                  <h2 class="product-name"> <a href="<?= base_url().'detail/'.$value['slug'].'/'.$value['id']?>"><?php echo $value['name']?></a></h2>
                </div>
                <div class="listview">
                  <h2 class="product-name"> <a href="<?= base_url().'detail/'.$value['slug'].'/'.$value['id']?>" ><?php echo $value['name']?></a></h2>
