<form method="post" action="<?php echo base_url('ci-admin/multi-footer/edit/'.$data[0]['id']) ?>">
   ...
   <input type="hidden" name="id" value="<?php echo $data[0]['id'] ?>" id="id">
    ...
    <button type="submit" name="subEditMultiFooter" class="btn btn-default">Submit</button>
  </form>