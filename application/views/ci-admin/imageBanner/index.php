...
<table class="table">
   <thead>
      <tr>
         ...
         <th>Status</th>
         <th>
            <a href="<?php echo base_url('ci-admin/upload-multi-image-banner') ?>">UpLoad Multi Image</a>
         </th>
      </tr>
   </thead>

   <tbody id="sortable-baner">
      ...
      <tr class="ui-state-default" id="item-<?php echo $value['id'] ?>">
         ...
         <td>
             <a href="<?php echo base_url('ci-admin/multi-banner/edit/'.$value['id']); ?>">
