<form method="post" action="<?php echo base_url('ci-admin/multi-banner/edit/'.$data[0]['id']) ?>">
   ...
   <input type="hidden" name="id" value="<?php echo $data[0]['id'] ?>" id="id">
    ...
    <button type="submit" name="subEditMultiBanner" class="btn btn-default">Submit</button>
  </form>